...
! calculate the Coulomb potential
      call genzvclmt(nrcmt,nrcmti,nrcmtmax,rlcmt,npcmtmax,zrhomt,zvclmt)
...
! calculate the Coulomb potential
            call zpotclmt(nrc,nrci,nrcmtmax,rlcmt(:,:,is),zrhomt(:,ias), &
             zvclmt(:,ias))
            z1=zfmtinp(nrc,nrci,rlcmt(:,3,is),zrhomt(:,ias),zvclmt(:,ias))
