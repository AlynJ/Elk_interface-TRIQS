...
! !ROUTINE: zfmtinp
! !INTERFACE:
complex(8) function zfmtinp(nr,nri,r3,zfmt1,zfmt2)
! !USES:
use modmain
! !INPUT/OUTPUT PARAMETERS:
!   nr    : number of radial mesh points (in,integer)
!   nri   : number of points on the inner part of the muffin-tin (in,integer)
!   r3    : r^3 on radial mesh (in,real(nr))
...
! integrate over r
zfmtinp=0.3333333333333333333d0*cmplx(splint(nr,r3,fr1),splint(nr,r3,fr2),8)
return
end function
!EOC
