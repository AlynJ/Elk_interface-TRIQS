        ...
        do m1=-l,l
          ...
          do m2=-l,l
            ...
            if (l.le.lmaxi) then
              ...
              a=splint(nrc,rlcmt(:,3,is),fr1)
              b=splint(nrc,rlcmt(:,3,is),fr2)
            else
              ...
              a=splint(nrco,rlcmt(irco,3,is),fr1(irco))
              b=splint(nrco,rlcmt(irco,3,is),fr2(irco))
            end if
            dmat(lm1,ispn,lm2,jspn,j)=cmplx(a,b,8)/3.d0
          end do
        end do
      end do
    end do
